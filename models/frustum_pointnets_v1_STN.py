...
def get_model(point_cloud, one_hot_vec, is_training, bn_decay=None):
   ...
   #############Invariance transformation Net###########################################
    ...
    print("poinr_cloud_transformed",poinr_cloud_transformed.get_shape())

    
    
    
    #point_cloud_concat = tf.concat([poinr_cloud_transformed,invariance_transformation_net],axis=-1)
    ...
    return end_points, point_cloud_xyz, poinr_cloud_transformed
